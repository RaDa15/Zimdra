...
(function () {
    ...
    const STORAGE_KEY = "zimdra_storekeeper_v5";
    ...
    function saveAddPartLine(event) {
        ...
        if (!partNo) {
            ...
            error.textContent =
                "Select a part to add to the requisition.";
    ...
    function populateTransferPartOptions() {
            ...
            ${
                available.map(function (product) {
                    ...
                    return `
                        ...
                        <option value="${escapeHtml(product.partNo)}">
                            ${escapeHtml(product.partNo)}
                            -
                            ${escapeHtml(product.name)}
                            (Stock: ${product.stock})
        ...
        if (!available.length) {
            ...
            select.innerHTML = `
                ...
                <option value="">
                    No parts currently at ${escapeHtml(supplying)}
                </option>
    ...
    function bindEvents() {
        ...
        document
            .getElementById("transferPartSelect")
            ?.addEventListener(
                "change",
                function () {

                    fillTransferAvailableStock(
                        this.value
                    );
